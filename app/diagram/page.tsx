        ...
        <div className="container py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-base sm:text-lg lg:text-xl leading-7 sm:leading-8 text-muted-foreground max-w-2xl lg:max-w-3xl mx-auto px-4 sm:px-0">
              ...
              <span className="font-semibold text-purple-600">process diagrams</span>{" "}
              with{" "}
              <span className="font-semibold bolt-gradient-text">Mermaid syntax and live preview</span>
            </p>
            ...
            <div className="mt-6 sm:mt-8 flex flex-wrap justify-center gap-4 sm:gap-6">
              <div className="glass-effect px-4 py-2 rounded-full hover:scale-105 transition-transform duration-300">
                <span className="bolt-gradient-text font-bold text-sm">Live</span>
                <span className="text-muted-foreground text-xs ml-1">Preview</span>
              </div>
              <div className="glass-effect px-4 py-2 rounded-full hover:scale-105 transition-transform duration-300">
                <span className="bolt-gradient-text font-bold text-sm">Export</span>
                <span className="text-muted-foreground text-xs ml-1">SVG/PNG</span>
              </div>
              <div className="glass-effect px-4 py-2 rounded-full hover:scale-105 transition-transform duration-300">
                <span className="bolt-gradient-text font-bold text-sm">Mermaid</span>
                <span className="text-muted-foreground text-xs ml-1">Syntax</span>
              </div>
            </div>
          </div>
            ...
            <div className="glass-effect p-6 sm:p-8 rounded-2xl max-w-2xl mx-auto hover:scale-105 transition-transform duration-300 relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-center gap-2 mb-4">
                  ...
                  <span className="font-semibold bolt-gradient-text text-lg">Ready to visualize your ideas?</span>
